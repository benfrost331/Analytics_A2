...
} else 
{
  ...
  for (i in seq_along(nu_grid)) {
    ...
    #Fit the split-brain network to the current nu value:
...
#Function to fit the standard nnetwork using optimisation
...
#Generate predicted class labels from the standard nnetwork
...
{
  #use same best_nu for a fair first comparison and fit a standard nnet
